...
class FaceView: UIView {
    ...
    @IBInspectable
    var mouthCurvature: Double = -0.75 { didSet { setNeedsDisplay() } }// 1.0 is full smile and -1.0 is full frown
    ...
    //now get the center of the view (needed to create a path using a arc)
